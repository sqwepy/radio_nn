...
total_amount_of_measurements = 1
parameters = 11
...
def _init_(path_,total_amount_of_measurements = 1, parameters = 11, event_level_parameters = 13, number_of_antennas = 160,grammage_steps = 1142, time_bins = 256, dimensions_antenna_positions_vB_vvB = 3, dimensions_antenna_traces_vB_vvB = 3,dimensions_antenna_traces_ge_ce = 2,time_ge_ce_and_vB_vvB = 2):
    '''
    Parameters:
